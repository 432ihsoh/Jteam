    ...
    switch (currentState.step) {
        ...
        case 22:
            if (userMessage === 'はい') {
                ...
                // 'いいえ' に対する処理
                const followUpQuestionText = '大堀相馬焼？（はい／いいえ）';
                // ステップを進める
                currentState.step = 37; // 新しい質問のステップ
                // ユーザーにフォローアップの質問を送信
                return client.replyMessage(event.replyToken, {
                    type: 'text',
                    text: followUpQuestionText
        ...
        case 27:
            ...
            case 28:
                if (userMessage === 'はい') {
                    ...
                    // 'いいえ' に対する処理
                    const followUpQuestionText = ' ユラックス温泉？（はい／いいえ）';
                    // ステップを進める
                    currentState.step = 29; // 新しい質問のステップ
                    // ユーザーにフォローアップの質問を送信
                    return client.replyMessage(event.replyToken, {
                        type: 'text',
                        text: followUpQuestionText
                ...
                case 29:
                    if (userMessage === 'はい') {
                       ...
                       const mapLocationText = 'ユラックス(熱海)の位置情報: https://www.google.com/maps?q=37.48056846776862,140.27806781100344';
                        ...
                        // 'いいえ' に対する処理
                        const followUpQuestionText = 'あぶくま洞？（はい／いいえ）';
                        // ステップを進める
                        currentState.step = 30; // 新しい質問のステップ
                        // ユーザーにフォローアップの質問を送信
                        return client.replyMessage(event.replyToken, {
                                ...
                                case 33:
                                    ...
                                    case 34:
                                        if (userMessage === 'はい') {
                                            ...
                                            // 'いいえ' に対する処理
                                            const followUpQuestionText = '郡山市立美術館？（はい／いいえ）';
                                            // ステップを進める
                                            currentState.step = 35; // 新しい質問のステップ
                                            // ユーザーにフォローアップの質問を送信
                                            return client.replyMessage(event.replyToken, {
                                        ...
                                        case 35:
                                            if (userMessage === 'はい') {
                                                ...
                                                // 'いいえ' に対する処理
                                                const followUpQuestionText = 'リカちゃんキャッス？（はい／いいえ）';
                                                // ステップを進める
                                                currentState.step = 36; // 新しい質問のステップ
                                                // ユーザーにフォローアップの質問を送信
                                                return client.replyMessage(event.replyToken, {
                                                    type: 'text',
                                                    text: followUpQuestionText
                                            ...
                                            if (userMessage === 'はい') {
                                                ...
                                                // 'いいえ' に対する処理
                                                const followUpQuestionText = '大堀相馬焼　陶徳窯？（はい／いいえ）';
                                                // ステップを進める
                                                currentState.step = 37; // 新しい質問のステップ
                                                // ユーザーにフォローアップの質問を送信
                                                return client.replyMessage(event.replyToken, {
                                                ...
                                                break;
                                                    ...
                                                    case 40:
                                                        if (userMessage === 'はい') {
                                                            ...
                                                            // 'いいえ' に対する処理
                                                            const followUpQuestionText = 'スペースパーク？（はい／いいえ）';
                                                            // ステップを進める
                                                            currentState.step = 41; // 新しい質問のステップ
                                                            // ユーザーにフォローアップの質問を送信
                                                            return client.replyMessage(event.replyToken, {
